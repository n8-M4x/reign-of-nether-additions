    ...
    public static boolean startProductionItem(ProductionBuilding building, String itemName, BlockPos pos) {
        ...
        if (building != null) {
            ...
            switch(itemName) {
                ...
                case ResearchBarracksProduction.itemName -> prodItem = new ResearchBarracksProduction(building);
                case ResearchBarracksProductionT2.itemName -> prodItem = new ResearchBarracksProductionT2(building);
                case ResearchBarracksProductionT3.itemName -> prodItem = new ResearchBarracksProductionT3(building);
                case ResearchPortalProduction.itemName -> prodItem = new ResearchPortalProduction(building);
                case ResearchPortalProductionT2.itemName -> prodItem = new ResearchPortalProductionT2(building);
                case ResearchPortalProductionT3.itemName -> prodItem = new ResearchPortalProductionT3(building);
                case ResearchGraveyardProduction.itemName -> prodItem = new ResearchGraveyardProduction(building);
                case ResearchGraveyardProductionT2.itemName -> prodItem = new ResearchGraveyardProductionT2(building);
                case ResearchGraveyardProductionT3.itemName -> prodItem = new ResearchGraveyardProductionT3(building);
