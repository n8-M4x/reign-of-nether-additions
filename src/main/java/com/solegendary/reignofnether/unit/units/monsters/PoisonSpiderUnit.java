...
public class PoisonSpiderUnit extends CaveSpider implements Unit, AttackerUnit {
    // region
    ...
    public static final EntityDataAccessor<String> ownerDataAccessor =
            SynchedEntityData.defineId(PoisonSpiderUnit.class, EntityDataSerializers.STRING);
